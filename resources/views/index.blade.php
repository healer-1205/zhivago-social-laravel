                    ...
                    <div class="hero-body">
                        <div class="form-wrapper">
                            ...
                            <div class="avatar">
                                ...
                                <img src="https://placehold.it/128x128" data-demo-src="assets/img/logo/Zhivago-white.svg" alt="">
                            </div>
                            <!--Form-->
                            <div class="login-form">
                                ...
                                <div class="field">
                                    <div class="control">
                                        <a href="./navbar-v1-stories-main.html" class="button is-solid primary-button raised is-rounded is-fullwidth"> Login </a>
<!--                                         <button class="button is-solid primary-button raised is-rounded is-fullwidth">Login</button>
 -->                                    </div>
                            <div class="has-text-centered">
                                <a href="/zhivago.live/signup-v2.html" target="_blank">Don't have an account? Create Account </a>
                            </div>
                                </div>
                            </div>
